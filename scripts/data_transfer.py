...
def extract_data_from_mongo(mongo_uri, mongo_db, mongo_collection):
    ...
    # Retry mechanism
    for _ in range(20):  # 20 attempts, 2 seconds apart
        try:
            db = client[mongo_db]
            ...
            transformed_data = [(city_data.get("city"), city_data.get("admin_name"), city_data.get("capital")) for
                                city_data in cities_data]
